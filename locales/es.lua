local Translations = {
    ...
    info = {
        ...
        drug_offer = "[~g~E~w~] %{bags}x %{drugLabel} for $%{randomPrice}? / [~g~G~w~] Rechazar oferta",
        pick_up_button = "[~g~E~w~] Recoger",
        knock_button = "[~g~E~w~] Golpear",
        mystery_man_button = "[~g~E~w~] Comprar / [~g~G~w~] ayuda a tu amigo ($5000)",
        other_dealers_button = "[~g~E~w~] Comprar / [~g~G~w~] Comenzar mision",
